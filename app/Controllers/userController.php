...
class userController extends BaseController
{
    ...
    {
        $keyword = $this->request->getGet('keyword');
        $subscriptions = $this->pendaftaranModel;

        if ($keyword) {
            $subscriptions = $subscriptions->like('LOWER(username)', strtolower($keyword))
                ->orLike('LOWER(nama_lengkap)', strtolower($keyword))
                ->orLike('LOWER(status)', strtolower($keyword))
                ->orLike('LOWER(paket_detail)', strtolower($keyword));
        }
